...
\bibitem{b1} Nishant Pathak, Sudhanshu Prakash Tiwari "Travelling Salesman Problem Using Bee Colony With SPV", International Journal of Soft Computing and Engineering (IJSCE) ISSN: 2231-2307, Volume-2, Issue-3, July 2012.
\bibitem{b2} Sarman K. Hadia, Arjun H. Joshi, Chaitalee K. Patel, Yogesh P Kosta "Solving City Routing Issue with Particle Swarm Optimization", International Journal of Computer Applications (0975 – 888) Volume 47– No.15, June 2012

\bibitem{b3} Kamil Rocki, Reiji Suda, "High Performance GPU Accelerated Local Optimization in TSP", 2013 IEEE 27th International Symposium on Parallel and Distributed Processing Workshops and PhD Forum.

\bibitem{b4} D. Karaboga and B. Gorkemli, "A combinatorial Artificial Bee Colony algorithm for traveling salesman problem," 2011 International Symposium on Innovations in Intelligent Systems and Applications, Istanbul, 2011, pp. 50-53.
\bibitem{b5} K. Ilavarasi and K. S. Joseph, "Variants of travelling salesman problem: A survey," International Conference on Information Communication and Embedded Systems (ICICES2014), Chennai, 2014, pp. 1-7.
\bibitem{b6} Elizabeth F. G. Goldbarg, Marco C. Goldbarg and Givanaldo R. de Souza (2008). Particle Swarm Optimization Algorithm for the Traveling Salesman Problem, Traveling Salesman Problem, Federico Greco (Ed.), ISBN: 978-953-7619-10-7.
\bibitem{b7} Comparison of MultiMap and TSP/CONCORDE for Constructing Radiation Hybrid Maps C. Hitte T. D. Lorentzen R. Guyon L. Kim E. Cadieu H. G. Parker P. Quignon J. K. Lowe B. Gelfenbeyn C. Andre E. A. Ostrander F. Galibert Journal of Heredity, Volume 94, Issue 1, 1 January 2003, Pages 9–13.
...
\bibitem{b9} M. Dorigo and G. Di Caro, "Ant colony optimization: a new meta-heuristic," Proceedings of the 1999 Congress on Evolutionary Computation-CEC99 (Cat. No. 99TH8406), Washington, DC, USA, 1999, pp. 1470-1477 Vol. 2.
\bibitem{b10} D. Karaboga and B. Gorkemli, "A combinatorial Artificial Bee Colony algorithm for traveling salesman problem," 2011 International Symposium on Innovations in Intelligent Systems and Applications, Istanbul, 2011, pp. 50-53.
\bibitem{b11} Particle swarm optimization-based algorithms for TSP and generalized TSP, X.H.Shi, Y.C.Liang, H.P.Lee, C.Lu, Q.X.Wanga.
\bibitem{b12} A new hybrid method based on Particle Swarm Optimization, Ant Colony Optimization and 3-Opt algorithms for Traveling Salesman Problem: Mostafa Mahi, Omer Kaan Baykan, Halife Kodaz.
\bibitem{b13} U. Cekmez, M. Ozsiginan, and O. K. Sahingoz, "Adapting the GA approach to solve Traveling Salesman Problems on CUDA architecture," 2013 IEEE 14th International Symposium on Computational Intelligence and Informatics (CINTI), Budapest, 2013, pp. 423-428.
\bibitem{b14} R. Saxena, M. Jain, S. Bhadri and S. Khemka, "Parallelizing GA based heuristic approach for TSP over CUDA and OPENMP," 2017 International Conference on Advances in Computing, Communications and Informatics (ICACCI), Udupi, 2017, pp. 1934-1940.
\bibitem{b15} Rui Li, Chun Cheng, Mingyao Qi and Weiwei Lai, "Design of dynamic vehicle routing system based on online map service," 2016 13th International Conference on Service Systems and Service Management (ICSSSM), Kunming, 2016, pp. 1-5.
\bibitem{b16} A. Annouch, A. Bellabdaoui and J. Minkhar, "Split delivery and pickup vehicle routing problem with two-dimensional loading constraints," 2016 11th International Conference on Intelligent Systems: Theories and Applications (SITA), Mohammedia, 2016, pp. 1-6.
\bibitem{b17} E. Messaoud and A. E. Alaoui, "Hybrid ant colony system algorithm for the vehicle routing problem with dynamic customers and traffic factors," 2017 Intelligent Systems and Computer Vision (ISCV), Fez, 2017, pp. 1-4.
\bibitem{b18} S. Mingprasert and R. Masuchun, "Adaptive artificial bee colony algorithm for solving the capacitated vehicle routing problem," 2017 9th International Conference on Knowledge and Smart Technology (KST), Chonburi, 2017, pp. 23-27.
\bibitem{b19} L. Meng, C. Lin, H. Huang and X. Cai, "Vehicle routing plan based on ant colony and insert heuristic algorithm," 2016 35th Chinese Control Conference (CCC), Chengdu, 2016, pp. 2658-2662.
